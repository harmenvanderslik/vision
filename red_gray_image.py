...
def show_edited_and_original_pic(image_path):
    ...
    fig, axs = plt.subplots(4, 1, figsize=(8, 6))  # Reduced width for compactness
    ...
    # Plot histograms
    axs[2].hist(original_hue_values, bins=90, color='blue', alpha=0.7)
    axs[2].set_title('Original Image Hue Distribution')
    axs[2].set_xlabel('Hue Value')
    axs[2].set_ylabel('Frequency')
    
    axs[3].hist(edited_hue_values, bins=90, color='red', alpha=0.7)
...
show_edited_and_original_pic('golden-gate-bridge-gettyimages-671734928.jpg')
